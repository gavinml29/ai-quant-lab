...
.panel-row{display:grid;grid-template-columns:180px 1fr;min-height:280px}
.panel-left{padding:12px 10px;border-right:1px solid var(--border);background:var(--bg2);overflow-y:auto;box-sizing:border-box}
.panel-right{padding:8px 12px;overflow:hidden;box-sizing:border-box}
